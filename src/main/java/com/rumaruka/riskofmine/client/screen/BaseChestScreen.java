...
@OnlyIn(Dist.CLIENT)
public class BaseChestScreen extends AbstractContainerScreen<ChestInventory> implements MenuAccess<ChestInventory> {
    ...
    public BaseChestScreen(ChestInventory container, Inventory playerInventory, Component title) {
